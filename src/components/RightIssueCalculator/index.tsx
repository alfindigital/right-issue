  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <footer className={`border-t border-border/60 mt-auto ${isMobile ? 'mb-14' : ''}`}>
        <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 py-4 px-4 text-[12px] text-muted-foreground">
          <span>
            by{' '}
            <a
          ...
          <nav className="flex items-center gap-3" aria-label="Social media">
            ...
            <a href="https://facebook.com/alfindigital" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-primary transition-colors">
